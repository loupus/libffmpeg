...
AVCodecContext* Demuxer::video_codec() {
	return avcontainer->streams[video_stream_index]->codec;
}
AVCodecContext* Demuxer::audio_codec() {
	return avcontainer->streams[audio_stream_index]->codec;
}
